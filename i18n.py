...
messages = {
    ...
    "GS390ADDIGRE": _("Error adding devices into cio-ignore list: '%(error)s'."),
    "GS390RMVIGRE": _("Error removing devices into cio-ignore list: '%(error)s'."),
    "GS390INVPARAM": _("Invalid parameter: '%(error)s'.")
}
